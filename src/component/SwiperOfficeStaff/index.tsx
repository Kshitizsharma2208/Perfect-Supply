...
import banner1 from "../../styles/images/Office.jpeg";
import bannerShade from "../../styles/images/banner-shape.png";
import "../../styles/common/common.scss";


const SwiperOfficeStaff = () => {
    return (
                ...
                <div className="carousel-inner" data-swiper-autoplay="5000">
                    <div className="carousel-item active">
                        ...
                        <div className="container content">
                            <p data-animation="fadeInUp" data-delay=".3s" className='animationTextBig'>Office Staff </p>
...
export default SwiperOfficeStaff