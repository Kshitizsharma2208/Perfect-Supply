...
import banner1 from "../../styles/images/Logistic.jpg";
import bannerShade from "../../styles/images/banner-shape.png";
import "../../styles/common/common.scss";


const SwiperLogicstics = () => {
    return (
                ...
                <div className="carousel-inner" data-swiper-autoplay="5000">
                    <div className="carousel-item active">
                        ...
                        <div className="container content">
                            <p data-animation="fadeInUp" data-delay=".3s" className='animationTextBig'>Logistic & <br /> E-Commerce </p>
...
export default SwiperLogicstics