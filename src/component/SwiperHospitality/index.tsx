...
import banner1 from "../../styles/images/Civil.jpeg";
import bannerShade from "../../styles/images/banner-shape.png";
import "../../styles/common/common.scss";


const SwiperHospitality = () => {
    return (
                ...
                <div className="carousel-inner" data-swiper-autoplay="5000">
                    <div className="carousel-item active">
                        ...
                        <div className="container content">
                            <p data-animation="fadeInUp" data-delay=".3s" className='animationTextBig'>Hospitality <br /> Construction</p>
...
export default SwiperHospitality