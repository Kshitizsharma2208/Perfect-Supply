...
import banner1 from "../../styles/images/IT.jpeg";
                ...
                <div className="carousel-inner" data-swiper-autoplay="5000">
                    <div className="carousel-item active">
                        ...
                        <div className="container content">
                            <p data-animation="fadeInUp" data-delay=".3s" className='animationTextBig'>Information <br /> Technology</p>
